...
namespace EasyCloudRequest\VolcTos\Auth;

use EasyCloudRequest\VolcTos\Helper\Helper;
use EasyCloudRequest\VolcTos\Model\Constant;
use EasyCloudRequest\VolcTos\Model\HttpRequest;

/**
 * source from volcengine Signer
 *
 * @link https://github.com/volcengine/ve-tos-php-sdk/blob/main/src/Auth/Signer.php
 */
trait Signer
{
    ...
    private static function getCanonicalHeaders(HttpRequest &$request, &$signedHeaders, array &$signedHeader)
    {
        ...
        foreach ($request->headers as $key => $val) {
            ...
            if (
                $lowerKey !== Constant::HeaderHostLower && $lowerKey !== Constant::HeaderContentTypeLower &&
